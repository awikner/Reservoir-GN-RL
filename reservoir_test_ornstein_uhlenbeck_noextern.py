...
x0 = np.array([6,4,0,9])
min_func_base = lambda x: vt_min_function_norm(np.ascontiguousarray(lorenz_data_ou), x, mask,\
...
ask me.
"""
foldername = '/lustre/awikner1/Reservoir-GN-RL/cmaes_lorenz_ou_noextern_res%d\\' % res_seed
