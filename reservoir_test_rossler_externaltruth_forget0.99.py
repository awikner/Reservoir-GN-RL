...
x0 = np.array([5.099767181664641, 9.229051971389161, 2.4922230183405265, 5.055436283218265])
...
ask me.
"""
foldername = '/lustre/awikner1/Reservoir-GN-RL/cmaes_lorenz_rossler_externtruth_forget%f_res%d' % (forget, res_seed)
